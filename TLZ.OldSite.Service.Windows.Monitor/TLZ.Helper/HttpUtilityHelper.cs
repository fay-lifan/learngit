...
namespace TLZ.Helper
{
    ...
    public static class HttpUtilityHelper
    {
        ...
        public static string UrlParamEncode(object obj)
        {
            if (obj == null)
                return string.Empty;
            return UrlParamEncode(obj.ToString());
        }

        public static string UrlParamEncode(string param)
        {
        ...
        public static string UrlParamDecode(object obj)
        {
            if (obj == null)
                return string.Empty;
            return UrlParamDecode(obj.ToString());
        }
