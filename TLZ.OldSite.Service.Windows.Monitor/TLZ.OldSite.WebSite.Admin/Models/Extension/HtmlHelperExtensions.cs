...
namespace TLZ.OldSite.WebSite.Admin.Models
{
    public static class HtmlHelperExtensions
    {
                                                   ...
                                                   string content = "")
        {
            ...
            url = isDisable ? url : string.Empty;
            string contentString = string.IsNullOrEmpty(content) ? index.ToString() : content;

            return new MvcHtmlString("<li " + activeClass + disableClass + "><a href=\"javascript:void(0);\" class=\"page-href\" page-href=" + url + ">" + contentString + "</a></li>");
        }
    }
}